...
function multiply(a, b) { //eslint-disable-line
   var multiply = a * b;
   var answer = "The product of " + a + " and " + b + " is " + multiply + "."
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
   ...
   var sumMultiply = multiply(multiply(a, b)[0], c);
   var answer1 = a + " and " + b + " and " + c + " sum to " + sumAnswer[0] + ".";
   var answer2 = "The product of " + a + " and " + b + " and " + c + " is " + sumMultiply[0] + ".";
   return [sumAnswer[0], sumMultiply[0], answer1, answer2];
}
